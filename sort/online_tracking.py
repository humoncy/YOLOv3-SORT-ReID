...
import sys
sys.path.append('/home/peng/Documents/scncd') # Path to scncd source code file directory
import scncd
...
def online_tracking(data_dir, STORE=False):
    """ Online tracking, detect and track in one step
        Params:
    ...
    for i, image_path in enumerate(tqdm(image_paths)):
        ...
        ####################### Sort Reid #############################
        # With ReID, need to input feature
        ...
        ####################### Sort #############################
        # Without ReID, just input detection results
...
if __name__ == '__main__':
    ...
    data_dir = '/home/peng/data/aerial/DJI_0009/'
